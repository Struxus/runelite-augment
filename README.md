...
- Replace all `Velaris` (case sensitive) with your server name.
- Replace all `Velaris` (case sensitive) with your lowercase server name.
- Replace `velaris.ps`/`velaris.ps` with your domain name.
