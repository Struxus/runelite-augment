...
cp native/build-x86/src/Release/Augment.exe build/win-x86/
cp build/libs/Augment.jar build/win-x86/
...
echo Augment.exe 32bit sha256sum
sha256sum build/win-x86/Augment.exe

dumpbin //HEADERS build/win-x86/Augment.exe
