...
cp native/build-x86/src/Release/Velaris.exe build/win-x86/
cp build/libs/Velaris.jar build/win-x86/
...
echo Velaris.exe 32bit sha256sum
sha256sum build/win-x86/Velaris.exe

dumpbin //HEADERS build/win-x86/Velaris.exe
