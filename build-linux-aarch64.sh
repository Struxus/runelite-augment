...
chmod 644 build/libs/Velaris.jar

cp native/build-aarch64/src/Velaris build/linux-aarch64/
cp build/libs/Velaris.jar build/linux-aarch64/
...
# Symlink AppRun -> Velaris
ln -s Velaris AppRun

# Ensure Velaris is executable to all users
chmod 755 Velaris
popd
