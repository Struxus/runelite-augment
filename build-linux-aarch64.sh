...
chmod 644 build/libs/Augment.jar

cp native/build-aarch64/src/Augment build/linux-aarch64/
cp build/libs/Augment.jar build/linux-aarch64/
...
# Symlink AppRun -> Augment
ln -s Augment AppRun

# Ensure Augment is executable to all users
chmod 755 Augment
popd
