...
cp native/build-aarch64/src/Release/Velaris.exe build/win-aarch64/
cp build/libs/Velaris.jar build/win-aarch64/
...
echo Velaris.exe aarch64 sha256sum
sha256sum build/win-aarch64/Velaris.exe

dumpbin //HEADERS build/win-aarch64/Velaris.exe
