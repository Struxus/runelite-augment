...
cp native/build-aarch64/src/Release/Augment.exe build/win-aarch64/
cp build/libs/Augment.jar build/win-aarch64/
...
echo Augment.exe aarch64 sha256sum
sha256sum build/win-aarch64/Augment.exe

dumpbin //HEADERS build/win-aarch64/Augment.exe
